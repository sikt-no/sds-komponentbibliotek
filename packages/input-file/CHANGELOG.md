...
## [1.1.0](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/compare/@sikt/sds-input-file@1.0.1...@sikt/sds-input-file@1.1.0) (2025-08-18)

### Features

- **file-list:** change styling of loading, success & error items ([a2578d0](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/a2578d0ba5de15df48cdf4912abffd631e375c15))
...
- **input-file:** new typography & label, help, error order ([4a0f46b](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/4a0f46bf77364df5903fa477064e841f574edaf5))
- **input-file:** update with new typography ([029952f](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/029952f7b28660f2dfc170aafe6ced9e07bc416a))

### Bug Fixes

- **deps:** update @sikt/sds-button & react-aria-components ([84f4610](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/84f4610d18697714352ce0dbbc444df38955cccb))
...
- **input-file:** rename actionProps

### Features

- **input-file:** rename actionProps ([2820499](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/2820499262e4f3b91499363792b29278c6c4454f))
- **input-file:** make value prop overridable ([2820499](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/2820499262e4f3b91499363792b29278c6c4454f))
...
- **input-file:** onChange return type ([5f68a30](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/5f68a3026a9aa0158381af7aa1090a22d8240bcd))

## 0.1.0 (2024-10-01)

### Features

- **input-file:** add component ([4734157](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/commit/47341570daa36330f824f49dc3ba10dc7c5b15a2))
