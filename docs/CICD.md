...
| slack-webhook-private    | Slack Webhook URL   | [Gitlab](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/-/settings/ci_cd)    | Used by the [pipeline](.gitlab-ci.yml) job `vuln-schedule-report` to post failed vulnerability scan results to #designsystem-internal on Slack.                | [Slack API](https://api.slack.com/apps/A060DV95L0L/incoming-webhooks)                                                               | never  | Slack  |
| slack-webhook-public     | Slack Webhook URL   | [Gitlab](https://gitlab.sikt.no/designsystem/sds-komponentbibliotek/-/settings/ci_cd)    | Used by the [pipeline](.gitlab-ci.yml) job `release-report` to succeeded releases to #designsystem-releases on Slack.                                          | [Slack API](https://api.slack.com/apps/A060DV95L0L/incoming-webhooks)                                                               | never  | Slack  |
...
| npm-token   | NPM Access Token    | [Vault](https://vault.sikt.no:8200/ui/vault/secrets/secret/kv/list/gitlab/designsystem/) | Used by the [pipeline](.gitlab-ci.yml) job `publish-npm` to publish new released packages to npm.                                                 | Add a Granular Access Token with _Read and write_ permission & scope _@sikt_                                                        | 90 days | [Kristoffer](https://gitlab.sikt.no/krnor) |
| figma-token | Figma API Token     | [Vault](https://vault.sikt.no:8200/ui/vault/secrets/secret/kv/list/gitlab/designsystem/) | Used by the [pipeline](.gitlab-ci.yml) job `publish-figma` to publish Figma Code Connect components to Figma.                                     | Go to Figma > User > Settings > Security > Personal access token > Code Connect: _Write_ & File _Read_                              | 90 days | [Kristoffer](https://gitlab.sikt.no/krnor) |
