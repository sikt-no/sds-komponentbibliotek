...
| npm-token   | NPM Access Token    | [Vault](https://vault.sikt.no:8200/ui/vault/secrets/secret/kv/list/gitlab/designsystem/) | Used by the [pipeline](.gitlab-ci.yml) job `publish-npm` to publish new released packages to npm.                                                 | Add a Granular Access Token with _Read and write_ permission & scope _@sikt_                                                        | 90 days | [Andreas](https://gitlab.sikt.no/andreas.solberg) |
