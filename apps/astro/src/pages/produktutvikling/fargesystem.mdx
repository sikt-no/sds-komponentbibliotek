...
Dette er den grunnleggende fargepaletten i SDS. Den består av utvalgte nyanser for følgende fargegrupper: Purple, Blue, Green, Yellow, Red og Neutral.
...
SDS har fire semantiske farger som brukes for å indikere status på oppgaver eller gi brukeren tilbakemelding. Disse er Info, Success, Warning og Critical.
