...
import LogoImageCard from "../../components/card/LogoImageCard.astro";
...
For å sikre tydelighet og leselighet er det definert en minimumsstørrelse
...
Av og til trenger vi en logo med en dypere forklaring av merkevaren vår.
...
tydelighet og leselighet er det definert en minimumsstørrelse for
...
For å sikre tydelighet og leselighet er det definert en minimumsstørrelse
for logoikonet vårt både for print og digitale flater.
...
Sikts merkevarestrategi fastslår at alle nye produkter og tjenester som
Sikt utvikler skal bruke Sikt-ikonet sammen med tjenestenavnet.

Eksisterende produkter med egen visuell profil skal også ta i bruk Sikts
visuelle identitet og logo, men endringen kan skje stegvis og over tid.
Endringer i eksisterende profil gjøres på en slik måte at vi ivaretar
