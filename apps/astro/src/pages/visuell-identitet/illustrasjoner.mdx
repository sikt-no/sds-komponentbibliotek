...
Vi har utarbeidet noen prinsipper som til sammen skal danne utrykket i vår illustrasjonsstil. Formspråket skal være minimalistisk og abstrahert, men skal likevel ha et varmt og naturlig formspråk.
...
- For motiver der man er tett på skal bære en personlighet ved å ha f.eks. øyne eller “ansikt”
...
Vi bruker en lilla fargepalett som fundament i Sikts illustrasjoner. Denne fargepaletten skal være tydelig til stede i alle illustrasjoner, men mindre det er veldig enkle illustrasjoner av objekter som f.eks. mynter eller trær.

![Hovedfargepalett](../../assets/images/visuell-identitet/illustrasjoner/hovedfargepalett.png)

### Fargepalett for hud

I tillegg til hovedfargepaletten har vi en egen fargepalett for hudfarger som brukes på alle mennesker. Sikts illustrasjoner skal kommunisere med hele bredden av den norske befolkning. Vi må være bevisste på å vise mangfold og bredde i hvordan vi fremstiller mennesker. Vi har derfor utviklet en fargepalett hvor vi kan velge mellom ulike hudtoner. Fargepaletten på bildet under viser hovedfargene for hud på Sikts illustrasjoner.

#### Hovedfarger for hud

![Hovedfarger for hud](../../assets/images/visuell-identitet/illustrasjoner/hovedfarger-for-hud.png)
...
![](../../assets/images/visuell-identitet/illustrasjoner/andre-hudfarger.png)
...
![](../../assets/images/visuell-identitet/illustrasjoner/utvidet-fargepalett.png)
...
![](../../assets/images/visuell-identitet/illustrasjoner/tilleggsfargene-ikke-bland-ulike-fargegrupper-i-samme-illustrasjon.png)
...
![](../../assets/images/visuell-identitet/illustrasjoner/tilleggsfargene-kan-kun-brukes-på-objekter-og-overdeler.png)

#### Unntak: når det er brukt støtteelementer

Det finnes sjelden regler uten unntak, og i dette tilfelle vil det være unntak fra retningslinjene når det er brukt støtteelementer i illustrasjonen. I eksemplene under er det brukt blader og blomster for å skape liv i illustrasjonen. I dette tilfellet er fargen grønn allerede brukt på bladene. Her kan du likevel bruke en ny tilleggsfarge på en annen ting, som eksempelvis en blomst eller et klesplagg.

![](../../assets/images/visuell-identitet/illustrasjoner/tilleggsfargene-unntak.png)
