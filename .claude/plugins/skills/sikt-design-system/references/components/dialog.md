...
| `className`            | `string`                            | no       | —       | —                                                                                                                                                                                                                                                                                                                                                       |
| `closeButtonAriaLabel` | `string`                            | yes\*    | —       | Required unless `closeButtonLabel` is set. Mutually exclusive with `closeButtonLabel`.                                                                                                                                                                                                                                                                  |
| `closeButtonLabel`     | `string`                            | yes\*    | —       | Required unless `closeButtonAriaLabel` is set. Mutually exclusive with `closeButtonAriaLabel`.                                                                                                                                                                                                                                                          |
